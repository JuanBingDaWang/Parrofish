...
ProviderName = Literal["siliconflow", "mineru", "bocha"]
...
class ApplicationSettingsService:
    ...
    def __init__(
        ...
        *,
        ...
        self._credential_sources = {
            ...
            "bocha": settings.bocha_credential_source,
        }
    ...
    def _apply_saved_runtime_settings(self) -> None:
        ...
        bocha_url = self.repository.get("bocha_base_url", self.settings.bocha_base_url)
        self.siliconflow.configure_provider(base_url=str(siliconflow_url))
        self.mineru.configure(base_url=str(mineru_url))
        self.bocha.configure(base_url=str(bocha_url))
    ...
    def provider_snapshot(self, provider: ProviderName) -> dict[str, object]:
        if provider == "siliconflow":
            ...
            configured = self.bocha.transport.credential_configured
            base_url = self.bocha.transport.base_url
        return {
            "provider": provider,
    ...
    def save_provider(
        ...
        *,
        ...
        credential_name = {
            "siliconflow": SILICONFLOW_CREDENTIAL,
            "mineru": MINERU_CREDENTIAL,
            "bocha": BOCHA_CREDENTIAL,
        }[provider]
        credential = None
        ...
        if provider == "siliconflow":
            ...
            self.bocha.configure(credential=credential, base_url=base_url)
    ...
    def delete_provider_credential(self, provider: ProviderName) -> None:
        ...
        if provider == "siliconflow":
            ...
            credential = fallback.bocha_api_key
            source = fallback.bocha_credential_source
            self.bocha.configure(credential=credential)
