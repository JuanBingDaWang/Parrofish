...
Generated files are written to `packaging/output/`. Temporary build and work files use the
short `%LOCALAPPDATA%\ParrofishBuild` path to avoid the legacy Windows path-length limit.
